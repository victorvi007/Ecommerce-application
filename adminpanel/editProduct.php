...
if (isset($_POST['addProduct'])) {
    ...
    if (
        ...
        $mainquery = "UPDATE product_db SET store_id ='$store_id',store_name='$store_name',product_name='$title',product_image_A='$newDestination_1',product_image_B='$newDestination_2',product_image_C='$newDestination_3',
                    ...
                    <form action="<?php echo ROOT_URL ?>/sellershub/editProduct.php?route=<?php echo $productIdUrl ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-container card bg-white p-1">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" cols="30" rows="10" class="form-control">  <?php echo $edit['product_description']; ?> </textarea>
                            </div>
                        </div>
                        <div class="form-container card bg-white p-1">
                            ...
                            <div class="row">
                                <div class="col-md-4  text-center" id="labelImage1">
                                    ...
                                    <input type="file" name="image1" id="image1" class="form-control-file" accept="image/*" value="<?php echo $edit['product_image_A']; ?>">
                                </div>
                                <div class="col-md-4  text-center" id="labelImage2">
                                    ...
                                    <input type="file" name="image2" id="image2" class="form-control-file" accept="image/*" value="<?php echo $edit['product_image_B']; ?>">
                                </div>
                                <div class="col-md-4  text-center" id="labelImage3">
                                    ...
                                    <input type="file" name="image3" id="image3" class="form-control-file" accept="image/*" value="<?php echo $edit['product_image_C']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="time" name="shipping_time" id="shippingTime" class="form-control" value="<?php echo $edit['shipping_time']; ?>">
                                    </div>
                                </div>
                            </div>
