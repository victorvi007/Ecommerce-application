...
if (isset($_POST['delete'])) {
    ...
    $deleteQuery = "DELETE FROM feedback WHERE id= '$delete_id'";
    if (mysqli_query($conn, $deleteQuery)) {
        $msg = "comment Deleted";
        $msgClass = "alert-success p-1";
    } else {
...
$commentQuery = "SELECT * FROM feedBack WHERE product_id = '$productIdUrl' ";
        ...
        <div class="container-fluid pb-5 bg-light">
            <div class="row">
                <div class="col-md-9 col-12 m-0">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                        <div class=" form-group text-right text-info">
                            <h4>Store name: <?php echo $edit['store_name']; ?> </h4>
                            <h4>Store ID: <?php echo $edit['store_id']; ?> </h4>
                            <h4></h4>
                            <!-- <a href="<?php echo ROOT_URL ?>sellershub/editProduct.php?route=<?php echo $productIdUrl ?>" class="btn btn-info px-5" name="addProduct"> <i class="fal fa-edit"></i> Edit Product </a> -->
                        </div>
                        ...
                        <div class="form-container card bg-white p-1">
                            ...
                            <div class="form-group">
                                ...
                                <h5 name="description" id="description" class="card pb-5 p-1"> <?php echo $edit['product_description']; ?> </h5>
                            </div>
                        </div>
                        <div class="form-container card bg-white p-1">
                ...
                <div class="col-md-3 col-12 p-0 m-0 border">
                    <h5 class="text-info text-center mt-3">Comments</h5>
                    <?php foreach ($comments as $comment) :; ?>
                        <form action="<?php echo ROOT_URL ?>adminPanel/viewProduct?route=<?php echo $productIdUrl; ?>" method="POST" class="p-1">
                            <div class="card p-1 m-1">
                                <p class="text-black">Name:<i class="text-info"><?php echo $comment['fullname'] ?></i> </p>
                                <p class="text-black">Title:<i class="text-info"><?php echo $comment['title'] ?></i></p>
                                <p class="text-black">Comment:<i class="text-info"> <?php echo $comment['feedback'] ?> </i></p>
                                <p class="text-black">Email:<i class="text-info"><?php echo $comment['email'] ?></i></p>
