...
$new = "UPDATE orders SET new =1 WHERE reference_code ='$product_id' ";
...
if (isset($_POST['pending'])) {
    $pendingQuery = "UPDATE orders SET delivered =1 WHERE reference_code ='$product_id' ";
    if (!mysqli_query($conn, $pendingQuery)) {
        echo mysqli_error($conn);
    };
}
if (isset($_POST['delivered'])) {
    $deliveredQuery = "UPDATE orders SET delivered =0 WHERE reference_code ='$product_id' ";
    mysqli_query($conn, $deliveredQuery);
}

$orderQuery = "SELECT * FROM orders WHERE reference_code='$product_id'";
$orderResult = mysqli_query($conn, $orderQuery);
$orders = mysqli_fetch_assoc($orderResult);
// print_r($orders);
mysqli_free_result($orderResult);

$product_details = $orders['product_id'];

$productQuery = "SELECT * FROM product_db WHERE product_Id='$product_details'";
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-5 text-right">
                            ...
                            <h4 class="pt-0 pt-2 <?php echo ($orders['delivered'] == 0) ? "text-warning" : "text-success"; ?> "><?php echo $orders['ordered_at']; ?></h4>
                ...
                <div class=" col-12 text-info">
                    <div class="row my-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <h6 class="pt-0"> Address: <?php echo $orders['delivery_address'] ?> </h6>
