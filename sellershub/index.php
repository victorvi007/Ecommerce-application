...
// print_r($storeId);
$orderQuery = "SELECT * FROM orders WHERE store_id='$storeId'";
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="container text-info my-5">
                                    <h3> <strong> WELCOME, <?php echo  $_SESSION['store_name']; ?> </strong> </h3>
